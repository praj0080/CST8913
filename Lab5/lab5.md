...
| 5  | A virtual private network service that allows you to create isolated networks within the cloud provider's infrastructure. | VPC | Azure Virtual Network (VNet) | Virtual Private Cloud (VPC) |
...
| 10 | A service for managing user access and encryption keys to secure cloud resources. | IAM & KMS | Azure AD & Key Vault | IAM & Cloud KMS |
...
| 12 | A service that provides monitoring and logging of applications and infrastructure, offering insights into resource usage and performance. | CloudWatch & X-Ray | Azure Monitor | Cloud Monitoring & Logging |
...
| 21 | A data catalog and governance service that helps manage metadata across your data estate, supporting compliance and security. | Data Catalog | Purview | Data Catalog |
| 22 | A set of machine learning and AI services that provide pre-built models, APIs, and tools for developers to easily implement AI in their apps. | SageMaker & AI Services | Azure AI & ML | Vertex AI |
| 23 | A service that allows you to define and deploy infrastructure using code, automating the management of cloud resources. | CloudFormation | Azure Resource Manager | Terraform / Deployment Manager |
...
| 26 | A backup and disaster recovery service that helps to protect your data by creating backups and replicas of your cloud resources. | Backup & DR | Azure Backup & Site Recovery | Backup & DR Service |
